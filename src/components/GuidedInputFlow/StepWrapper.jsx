      ...
      <div className="flex justify-between items-center pt-6">
        <button
          ...
          className={`px-4 py-2 text-sm rounded-md text-white transition
            ${step === 1 ? 'bg-gray-300 dark:bg-gray-400 border border-gray-400 dark:text-gray-300 dark:border dark:border-gray-700 cursor-not-allowed' : 'bg-blue-500 border border-blue-600 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-500 dark:border dark:border-blue-800'}`}
        >
          Back
        </button>
        <button
